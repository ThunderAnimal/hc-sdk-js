...
class HealthCloud {
  constructor({ documentService, zeroKitAdapter }) {
    ...
    this.downloadDocument = documentService.downloadDocument.bind(
      documentService
    );
    ...
    this.getDocumentsCount = documentService.getDocumentsCount.bind(
      documentService
    );
    ...
    this.getGrantedPermissions = userService.getGrantedPermissions.bind(
      userService
    );
...
class HealthCloudWeb extends HealthCloud {
  constructor(options) {
    ...
    this.getRegistrationForm = zeroKitAdapter.getRegistrationForm.bind(
      zeroKitAdapter
    );
